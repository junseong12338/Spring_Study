...
//	public String test4(@SessionAttribute("bean1") DataBean1 bean1) {
	...
	public String result5(@ModelAttribute("sessionBean1") DataBean1 sessionBean1,
		...
		System.out.println("sesstionBean1.data1 :" + sessionBean1.getData1());
		System.out.println("sesstionBean1.data2 :" + sessionBean1.getData2());
		
		System.out.println("sesstionBean2.data1 :" + sessionBean2.getData1());
		System.out.println("sesstionBean2.data2 :" + sessionBean2.getData2());
